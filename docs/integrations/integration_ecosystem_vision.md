...
- `docs/vision/devos_kernel_architecture.md` — Canonical four-system architecture; Capability System responsibilities
- `docs/architecture/system_map.md` — Capability System module map
